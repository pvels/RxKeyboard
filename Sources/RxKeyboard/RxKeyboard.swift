...
//
    ...
    public class RxKeyboard: NSObject, RxKeyboardType {
        ...
        override init() {
            ...
            visibleHeight = frame.map {
                print(UIScreen.main.bounds.height, $0.origin.y, UIScreen.main.bounds.height - $0.origin.y)
                return UIScreen.main.bounds.height - $0.origin.y
            }
